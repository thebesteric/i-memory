...
class DMLOps:
    ...
    def ins_mem(self, **k):
        sql = """
              INSERT INTO memories(id, user_id, segment, content, primary_sector, tags, meta, created_at, updated_at, last_seen_at, salience,
              ...
              UPDATE SET
                  user_id=EXCLUDED.user_id, segment=EXCLUDED.segment, content=EXCLUDED.content, primary_sector=EXCLUDED.primary_sector,
